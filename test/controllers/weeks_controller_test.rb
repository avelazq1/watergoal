...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { day: @week.day, droplets: @week.droplets, integer: @week.integer, string: @week.string }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { day: @week.day, droplets: @week.droplets, integer: @week.integer, string: @week.string }
    assert_redirected_to week_path(assigns(:week))
  end
